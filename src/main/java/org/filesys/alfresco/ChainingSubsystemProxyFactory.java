...
public class ChainingSubsystemProxyFactory extends ProxyFactoryBean
{
    ...
    protected static final Log logger = LogFactory.getLog(ChainingSubsystemProxyFactory.class);
    ...
    {
        logger.debug("** ChainingSubsystemProxyFactory() **");

        addAdvisor(new DefaultPointcutAdvisor(new MethodInterceptor()
        {
            public Object invoke(MethodInvocation mi) throws Throwable
            {
                logger.debug("** invoke() called, method=" + mi.getMethod().getName() + " **");
    ...
    public void setInterfaces(Class[] interfaces)
    {
        ...
        logger.debug("** setInterfaces() = " + interfaces);
    }
    ...
    public void setApplicationContextManager(ChildApplicationContextManager applicationContextManager)
    {
        ...
        logger.debug("** setApplicationContextManager()");
    }
    ...
    public void setSourceBeanName(String sourceBeanName)
    {
        ...
        logger.debug("** setSourceBeanName() name=" + sourceBeanName);
    }
    ...
    public void setDefaultTarget(Object defaultTarget)
    {
        ...
        logger.debug("** setDefaultTarget() target=" + defaultTarget);
    }
}
